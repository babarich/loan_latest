...
<div class="row mt-4">
    <div class="col-xl-12">
         <form action="{{ route('report.balance') }}" method="GET" class="mb-4">
        <div class="row">
            <div class="col-md-3">
        ...
        <div class="h5 mb-0 d-sm-flex d-block align-items-center">
            <div class="ms-sm-2 ms-0 mt-sm-0 mt-2">
                <div class="h6 fw-semibold mb-0">
                    Balance Sheet As of <span class="text-primary">{{ \Carbon\Carbon::now()->format('Y-m-d') }}</span>
                </div>
            </div>
        </div>
    ...
    <div class="card-body" id="printableArea">
        <div class="row gy-3">
            ...
            <!-- Balance Check -->
            <h3 class="mt-4">Balance Check</h3>
            <p>
